...
-- AddForeignKey
ALTER TABLE "Gpu" ADD CONSTRAINT "Gpu_paneGpulId_fkey" FOREIGN KEY ("paneGpulId") REFERENCES "PanelGpu"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Cpu" ADD CONSTRAINT "Cpu_panelCpuId_fkey" FOREIGN KEY ("panelCpuId") REFERENCES "PanelCpu"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PowerSupply" ADD CONSTRAINT "PowerSupply_PanelPowerSupplyId_fkey" FOREIGN KEY ("PanelPowerSupplyId") REFERENCES "PanelPowerSupply"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Storage" ADD CONSTRAINT "Storage_panelStorageId_fkey" FOREIGN KEY ("panelStorageId") REFERENCES "PanelStorage"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Ram" ADD CONSTRAINT "Ram_panelRamId_fkey" FOREIGN KEY ("panelRamId") REFERENCES "PanelRam"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MotherBoard" ADD CONSTRAINT "MotherBoard_panelMotherBoardId_fkey" FOREIGN KEY ("panelMotherBoardId") REFERENCES "PanelMotherBoard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
